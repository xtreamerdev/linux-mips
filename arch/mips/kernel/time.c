 ...
 * enabled briefly - prom_smp_finish() should not be responsible for enabling interrupts...) 
 *
...
void __init synchronise_count_master (void)
{
	...
	printk(KERN_INFO "Checking COUNT synchronization across %u CPUs: ", num_online_cpus());
