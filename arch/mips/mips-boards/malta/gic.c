...
void ipi_call_function(unsigned int cpu)
{
	...
	case 1:
		...
		break;
	case 2:
		GIC_REG(SHARED, GIC_SH_WEDGE) = (0x80000000 | GIC_IPI_EXT_INTR_CALLFNC_VPE2);
		break;
	case 3:
...
void ipi_resched(unsigned int cpu)
{
	...
	case 1:
		...
		break;
	case 2:
		GIC_REG(SHARED, GIC_SH_WEDGE) = (0x80000000 | GIC_IPI_EXT_INTR_RESCHED_VPE2);
		break;
	case 3:
...
static void gic_irq_init(unsigned int numintrs)
{
	...
	gic_pcpu_imasks[2] = ((1 << GIC_IPI_EXT_INTR_RESCHED_VPE2) | (1 << GIC_IPI_EXT_INTR_CALLFNC_VPE2));
	gic_pcpu_imasks[3] = ((1 << GIC_IPI_EXT_INTR_RESCHED_VPE3) | (1 << GIC_IPI_EXT_INTR_CALLFNC_VPE3));
